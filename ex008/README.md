...
<body>
    ...
    <p>Como dizia o pai do meu amigo: <q>o computador é um burro muito rápido.</q></p>
    <h2>Citações completa</h2>
    <p>Segundo Jeff Noble, no seu livro HTML para leigos:</p>
    <blockquote cite="https://books.google.com.br/books?id=E8ZtDwAAQBAJ&pg=PA17&dq=html&hl=pt-BR&sa=X&ved=2ahUKEwiax7mrgO7tAhVCF7kGHX1vBBgQ6AEwAHoECAMQAg#v=onepage&q&f=false"> 
